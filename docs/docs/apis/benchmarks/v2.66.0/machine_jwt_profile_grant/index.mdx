...
| Observed errors                       |                                                                                                                                                                                                                                        |
| Top 3 most expensive database queries | 1: Write events using the newly added eventstore.push function<br/>2: Query events by instance_id, aggregate_type, aggregate_id, event_types<br/>3: Query user<br/>                                                                    |
